...
import com.example.collegeapp.databinding.SampleCourseBinding
import com.example.collegeapp.databinding.SampleFirstyearBinding
import com.example.collegeapp.models.*

class DevelopAdapter(val context: Context, val list:ArrayList<DevelopModel>): RecyclerView.Adapter<DevelopAdapter.ViewHolder>() {
    class ViewHolder(val binding:SampleCourseBinding)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(SampleCourseBinding.inflate(LayoutInflater.from(context),parent,false))
    }
